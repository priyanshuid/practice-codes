...
var MultiBox = new Class({
    ...
    this.nextButton = new Element('div').setProperty('id', this.options.mbnid).addClass(this.options.mbnclass).inject(this.controls, 'inside').addEvents({'click' : this.next.bind(this), 'dblclick' : this.next.bind(this)});
		} else {
